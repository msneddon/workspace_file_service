...
class WorkspaceFileHandler(object):
    ...
    def getAllFileTypes(self):
        ...
        arg_hash = {'method': 'WorkspaceFileHandler.getAllFileTypes',
                    'params': [],
                    'version': '1.1',
    ...
    def getUploadableFileTypes(self):

        arg_hash = {'method': 'WorkspaceFileHandler.getUploadableFileTypes',
                    'params': [],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def getDownloadableFileTypes(self):

        arg_hash = {'method': 'WorkspaceFileHandler.getDownloadableFileTypes',
                    'params': [],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def getFileType(self, ids):

        arg_hash = {'method': 'WorkspaceFileHandler.getFileType',
                    'params': [ids],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def upload(self, parameters):
        ...
        arg_hash = {'method': 'WorkspaceFileHandler.upload',
                    'params': [parameters],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def upload_batch(self, paramameters_list):

        arg_hash = {'method': 'WorkspaceFileHandler.upload_batch',
                    'params': [paramameters_list],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def download(self, parameters):
        ...
        arg_hash = {'method': 'WorkspaceFileHandler.download',
                    'params': [parameters],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def download_batch(self, parameters):

        arg_hash = {'method': 'WorkspaceFileHandler.download_batch',
                    'params': [parameters],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def getDownloader(self, ids):

        arg_hash = {'method': 'WorkspaceFileHandler.getDownloader',
                    'params': [ids],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def getUploader(self, ids):

        arg_hash = {'method': 'WorkspaceFileHandler.getUploader',
                    'params': [ids],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
